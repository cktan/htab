...
//#include <Common/Exception.h>  ##akonpatch
...
struct ZeroValueStorage<false, Cell>
{
    ...
    //##akonpatch: void setHasZero() { throw DB::Exception("HashTable: logical error", DB::ErrorCodes::LOGICAL_ERROR); }
    ...
    public:
        ...
        inline const value_type & get() const
        {
            if (!is_initialized || is_eof)
                //##akonpatch: throw DB::Exception("No available data", DB::ErrorCodes::NO_AVAILABLE_DATA);
